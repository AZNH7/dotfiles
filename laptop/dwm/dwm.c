...
// Whether the systray is on the left
int systrayonleft = 0;

// Spacing between systray icons
int systrayspacing = 2;

// Whether the systray is pinned to a specific monitor
int systraypinning = 0;

// Whether to fail to the first monitor if pinning fails
int systraypinningfailfirst = 1;
...
drawbar(Monitor *m)
{
	...
	if(systray && m == systraytomon(m) && !systrayonleft)
		stw = getsystraywidth();
