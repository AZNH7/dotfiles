...
kobayashi = colors.kobayashi()
softpastel = colors.softpastel()
...
# hook to bring back focus to the last used group when a window is killed
@hook.subscribe.client_killed
def focus_last_group(qtile, ev):
