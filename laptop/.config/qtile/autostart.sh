...
rsync -avp --exclude={home_server, Nextcloud, gom, .cache, .conda, .cargo, Games, games, .local/share, .config/heroic, .rustup} /home/aziz/home_server/aziz-work/laptop_backup/flink/$(date +%Y-%m-%d)
